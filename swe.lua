			...
			function Section:Configlist(options)
				...
				--[[
					...
					if ConfigsTable.configplaceids ~= nil then
						return tostring(table.concat(ConfigsTable.configplaceids.ids, '-'))
					end
				end]]
							...
							if (action == 'create') then
								...
								if not isfile(NewWindow.MenuName..'\\configs\\'..configname..'.txt') then
									if ConfigsTable.configplaceids == nil then
										...
										if not isfolder(NewWindow.MenuName..'\\configs\\'..ConfigsTable.configplaceids.filename) then makefolder(NewWindow.MenuName..'\\configs\\'..ConfigsTable.configplaceids.filename) end
